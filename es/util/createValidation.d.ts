...
export declare type TestFunctionWas<T = unknown, TContext = {}> = (this: TestContext<TContext>, value: T, context: TestContext<TContext>) => boolean | ValidationError | Promise<boolean | ValidationError>;
export declare type TestFunction<T = unknown, TContext = {}> = TestFunctionWas<T, TContext> & {
    async?: boolean;
};
...
export default function createValidation(config: {
    ...
    <TSchema extends AnySchema<any, any, any> = AnySchema<any, any, any>>({ value, path, label, options, originalValue, sync, ...rest }: TestOptions<TSchema>, cb: Callback): Promise<boolean | ValidationError> | undefined;
    OPTIONS: {
